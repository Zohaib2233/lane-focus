...
class FirebaseStorageService {
  ...
  Future<FilePickerResult?> pickCustomFile() async {
    FilePickerResult? result = await FilePicker.platform.pickFiles(
      ...
      allowedExtensions: [
        ...
        'xls',
        'xlsx'
      ], // Add extensions you want to allow
    );
  ...
  Future<FilePickerResult?> pickFile(
      {required FileType fileType, bool allowMultiple = false}) async {
    FilePickerResult? result = await FilePicker.platform.pickFiles(
      type: fileType,
  ...
  Future<(String, bool)> uploadFile(
      {String storageRef = "audio", FilePickerResult? result}) async {
    try {
      ...
      if (result != null) {
        ...
        Reference reference =
            FirebaseStorage.instance.ref().child(storageRef).child(fileName);
  ...
  Future<String> uploadFileToStorage(
      {required String filePath, String storageRef = "audio"}) async {
  ...
  Future<String> uploadSingleImage(
    ...
    try {
      ...
      var snapshot =
          await ref.putData(bytes).timeout(Duration(seconds: 30)); //THIS LINE
